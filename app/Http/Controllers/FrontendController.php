...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = CompanyInfo::all();
            ...
            $n['products'] = DB::table('products')->where('condition', '=', 'new')->orderBy('id', 'DESC')->limit('10')->get();
            $n['products_hot'] = DB::table('products')->where('condition', '=', 'hot')->orderBy('id', 'DESC')->limit('10')->get();
