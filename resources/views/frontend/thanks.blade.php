        ...
        <div class="wrapper-container thanks-page">
            <div class="card thank-card">
                <div class="card-body text-center ">
                    <p class="pt-3"><i class="fas fa-check-circle thank-icon"></i></p>
                    <h3 class="text-wrap text-white">ধন্যবাদ অর্ডার করার জন্য 😊 খুব শীঘ্রই আপনার সাথে যোগাযোগ করা হবে। অথবা যেকোনো
                        প্রয়োজনে কল করুন {{ $site_contact_info->phone }}</h3>
                </div>
            </div>
